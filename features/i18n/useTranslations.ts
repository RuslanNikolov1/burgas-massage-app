...
const translations: Translations = {
  ...
  'pricing.note': { bg: 'Всяка терапия включва енергийна работа и завършва с 10 минути водена медитация – комплимент от нас', en: 'Every therapy includes energy work and ends with 10 minutes of guided meditation – our complimentary gift' },
  'pricing.duration': { bg: 'Време', en: 'Time' },
  'pricing.price': { bg: 'Цена', en: 'Price' },
  'pricing.sections.partial.title': { bg: 'ЧАСТИЧНИ ТЕРАПИИ', en: 'PARTIAL THERAPIES' },
  'pricing.sections.partial.subtitle': { bg: 'Енергийна терапия + масаж (зона по избор)', en: 'Energy therapy + massage (area of choice)' },
  'pricing.sections.partial.areas': { bg: 'Зони: гръб • врат и рамене • кръст • крака', en: 'Areas: back • neck and shoulders • sacrum • legs' },
  'pricing.sections.partial.40.duration': { bg: '40 мин', en: '40 min' },
  'pricing.sections.partial.40.price': { bg: '30 евро', en: '30 EUR' },
  'pricing.sections.partial.60.duration': { bg: '60 мин', en: '60 min' },
  'pricing.sections.partial.60.price': { bg: '40 евро', en: '40 EURO' },
  'pricing.sections.complete.title': { bg: 'ЦЯЛОСТНИ ТЕРАПИИ', en: 'COMPLETE THERAPIES' },
  'pricing.sections.complete.subtitle': { bg: 'Енергийна терапия + цялостен масаж', en: 'Energy therapy + complete massage' },
  'pricing.sections.complete.70.duration': { bg: '70 мин', en: '70 min' },
  'pricing.sections.complete.70.price': { bg: '50 евро', en: '50 EURO' },
  'pricing.sections.complete.90.duration': { bg: '90 мин', en: '90 min' },
  'pricing.sections.complete.90.price': { bg: '65 евро', en: '65 EURO' },
  'pricing.sections.premium.title': { bg: 'ПРЕМИУМ ТЕРАПИЯ', en: 'PREMIUM THERAPY' },
  'pricing.sections.premium.subtitle': { bg: 'Енергийна терапия + цялостен масаж + удължена медитация', en: 'Energy therapy + complete massage + extended meditation' },
  'pricing.sections.premium.120.duration': { bg: '120 мин', en: '120 min' },
  'pricing.sections.premium.120.price': { bg: '80 евро', en: '80 EURO' },
  'pricing.sections.packages.title': { bg: 'ПАКЕТНИ ТЕРАПИИ', en: 'PACKAGE THERAPIES' },
  'pricing.sections.packages.5.therapy': { bg: '5 терапии', en: '5 therapies' },
  'pricing.sections.packages.5.discount': { bg: '10% отстъпка', en: '10% discount' },
  'pricing.sections.packages.10.therapy': { bg: '10 терапии', en: '10 therapies' },
  'pricing.sections.packages.10.discount': { bg: '15% отстъпка', en: '15% discount' },
  ...
  'products.viewDetails': { bg: 'Детайли', en: 'Details' },
  'products.details.back': { bg: 'Обратно към продуктите', en: 'Back to products' },
  'products.details.cta': { bg: 'Свържи се с мен', en: 'Contact me' },
  'products.items.pindi.title': { bg: 'Пинди', en: 'Pindi' },
  'products.items.pindi.shortDescription': { bg: 'Билкови торбички за лечебен масаж', en: 'Herbal pouches for therapeutic massage' },
  'products.items.pindi.price': { bg: '35 евро за пакет', en: '35 EUR for package' },
  'products.items.pindi.longDescription': {
    bg: 'Открийте магията на българските пинди с билки – естествената грижа за тялото и душата!\n\nПотопете се в уникалното изживяване на традиционния български масаж с нашите ръчно изработени пинди, пълни с едра сол от солниците в Поморие, ароматна лавандула и свеж розмарин. Всяка торбичка е внимателно приготвена с любов и внимание към детайла, за да ви донесе истинско облекчение, релакс и хармония.\n\nЗащо да изберете нашите пинди?\n\nАвтентичен български продукт – съчетание от природни съставки с доказани лечебни свойства.\n\nРъчна изработка – всяка пинда е уникална, създадена с грижа и уважение към традициите.\n\nДълбоко релаксиращ ефект – топлината и ароматите проникват в мускулите, облекчават напрежението и стимулират кръвообращението.\n\nПодходящи за всеки тип кожа – естествени материали и билки, без химикали и изкуствени добавки.\n\nПодарете си момент на истинско спокойствие и възстановяване. Нашите пинди са перфектният избор за професионални масажисти и за домашна грижа.\n\nПоръчайте сега и усетете силата на природата в ръцете си!',
    en: 'Discover the magic of Bulgarian herbal pindi—natural care for body and soul!\n\nImmerse yourself in a unique traditional Bulgarian massage experience with our handmade pindi, filled with coarse salt from the Pomorie salt pans, fragrant lavender, and fresh rosemary. Each pouch is prepared with love and attention to detail to bring you real relief, relaxation, and harmony.\n\nWhy choose our pindi?\n\nAuthentic Bulgarian product — a blend of natural ingredients with proven beneficial properties.\n\nHandmade — every pindi is unique, created with care and respect for tradition.\n\nDeeply relaxing effect — warmth and aromas sink into the muscles, ease tension, and stimulate circulation.\n\nSuitable for every skin type — natural materials and herbs, with no chemicals or artificial additives.\n\nTreat yourself to a moment of true calm and recovery. Our pindi are a perfect choice both for professional massage therapists and for home care.\n\nOrder now and feel the power of nature in your hands!',
  },
  ...
  'products.items.1.price': { bg: '22 евро', en: '22 EURO' },
  ...
  'products.items.2.price': { bg: '40 евро', en: '40 EURO' },
  ...
  'products.items.3.price': { bg: '18 евро', en: '18 EURO' },
  ...
  'products.items.4.price': { bg: '13 евро', en: '13 EURO' },
  ...
  'products.items.5.price': { bg: '27 евро', en: '27 EURO' },
  ...
  'products.items.6.price': { bg: '15 евро', en: '15 EURO' },
